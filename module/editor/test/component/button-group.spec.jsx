...
describe('ButtonGroup', () => {
  ...
  it('renders ButtonGroup component with children', () => {
  ...
  it('renders ButtonGroup component with multiple children', () => {
    render(<ButtonGroup>{[mockChild1, mockChild2]}</ButtonGroup>);
  ...
  it('renders ButtonGroup component with no children', () => {
